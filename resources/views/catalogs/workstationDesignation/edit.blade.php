    ...
    <div class="row gutters">
      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card">
          ...
          {!! Form::open(array('route' =>['workstation-designations.update', $workstationDesignation->id],'method'=>'PUT','files'=>true)) !!}
          <div class="card-body">
            <div class="col-md-12">
                      ...
                      <div class="field-wrapper">
                        <div class="input-group">
                          <select  name="workstation_id" id="workstation_id" class="form-control select2" required="">
                            ...
                            <option value="{{$workstation->id}}" {{($workstationDesignation->workstation_id == $workstation->id) ? 'selected' : ''}}
                              >
                              {{$workstation->name}}
                            </option>
                            @endforeach
                    ...
                    <div class="col-md-12">
                      <div class="field-wrapper">
                        <select  name="designation_id" id="designation_id" class="form-control select2" required="">
                          ...
                          <option value="{{$designation->id}}" {{($workstationDesignation->designation_id == $designation->id) ? 'selected' : ''}}
                            >
                            {{$designation->title}}
                          </option>
                          @endforeach
