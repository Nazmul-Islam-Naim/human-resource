...
<script>
   ...
   function dateFormat(data) { 
    ...
    var table = $('#example').DataTable({ 
			...
			processing: true,
			ajax: {
        url: "{{route('publicationInformations.index')}}",
      },
            ...
            },
            {
                ...
                messageTop: function () {
                  var top = '<center><p class ="text-center"><img src="{{asset("backend/custom/images")}}/header.png" height="100"/></p></center>';
                    top += '<h5>কর্মকর্তা/কর্মচারীর প্রকাশনা সম্পর্কিত তথ্যাদির তালিকাঃ</h5>';
     ...
     $("#example").on("click", ".button-delete", function(e) {
        ...
        var id = $(this).data('id');
        var link = '{{route("publicationInformations.destroy",":id")}}';
