                                        ...
                                        <table
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>পিআরএল- <br>এর তারিখ</th>
                                                    <th>নিজ জেলা</th>
                                                    <th>বিশেষ <br>মন্তব্য</th>
                                                </tr>
                                            </thead>
                                            <tbody></tbody>
                                        </table>
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            messageTop: function() {
                                ...
                                top +=
                                    '<h5>কর্মকর্তা / কর্মচারীগণের পদওয়ারী বর্তমান কর্মস্থলঃ</h5>';
                            ...
                            customize: function(win) {
                                ...
                                $(win.document.body).find('table thead tr').css('position',
                                    'sticky');
                                $(win.document.body).find('table thead tr th').css('text-align',
                                    'center');
                                $(win.document.body).find('table thead tr th').css('word-wrap',
                                    'break-word');
                                $(win.document.body).find('table thead tr th').css('white-space',
                                    'normal !important');
