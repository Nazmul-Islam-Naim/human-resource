                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    ...
                    required="">
                      ...
                      <option value="{{$promotionWorkstation->id}}" {{(($promotionInformation->workstation_id == $promotionWorkstation->id) ?? (old('workstation_id') == $promotionWorkstation->id)) ? 'selected' : ''}}>{{$promotionWorkstation->name}}</option>
                      @endforeach
                    </select>
                  </div>
