...
<div class="content-wrapper-scroll">
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        {!! Form::open(array('route' =>['employee-pension-prl',$generalInformation->id],'method'=>'POST','files'=>true)) !!}
        <div class="card">
            ...
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-2 mb-3">
                <p>নামঃ {{ $generalInformation->name_in_bangla }} ||
                  ...
                  পি আর এল তারিখঃ  {{$numTo->bnNum(date('d',strtotime($generalInformation->prl_date)))}}/
                  {{$numTo->bnNum(date('m',strtotime($generalInformation->prl_date)))}}/{{$numTo->bnNum(date('Y',strtotime($generalInformation->prl_date)))}} খ্রিঃ</p>
              </div>
          ...
          <div class="card-footer text-end">
            <button class="btn btn-primary" type="submit"><i class="icon-save"></i> পেনশন যোগ করুন</button>
          </div>
        </div>
        {!! Form::close() !!}
      </div>
